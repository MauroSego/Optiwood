...
if(!empty($_POST['btnRegistrarBanco'])){
    if(InsertarBanco() != false){
        $_SESSION['MensajeOK'] = "Banco registrado correctamente";
    } else {
        $_SESSION['MensajeError'] = 'No se puedo registrar el banco. Intente nuevamente';
    } 
}
?>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Registrar bancos</strong> 
                                    </div>
                                    <div class="card-body card-block">
                                        <form method="post" class="form-group">
                                            <label for="nombreBanco">Banco</label>
                                            <input name="nombreBanco" type="text" class="form-control" id="nombreFormaPago">
                                            <input type="submit" class="btn btn-primary" name="btnRegistrarBanco" value="Registrar"/>
                                        </form>
